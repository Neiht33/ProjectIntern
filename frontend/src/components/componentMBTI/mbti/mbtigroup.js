...
export default function MBTI() {
     ...
     const handleMBTIClick = (link, title) => {
          setSelectedMBTI({ link, title });
     };

     return (
          <div
               style={{
                    background: "linear-gradient(180deg,#01543a,#20a35e)",
                    paddingTop: "50px",
                    paddingBottom: "50px",
               }}
          >
               ...
               >
                    <div>
                         <Link to="/mbti">
                              <Button variant="outlined">
                                   <i className="fa-solid fa-arrow-left"></i> Trang chủ MBTI
                              </Button>
                         </Link>
                    </div>
                    <div>
                         <Menu>
                              <MenuHandler>
                                   <Button variant="filled">
                                        {selectedMBTI ? selectedMBTI.title : "Chọn một loại MBTI"}{" "}
                              ...
                              <MenuList className=" menu-list">
                                   {cardData.map((card, index) => (
                                        <MenuItem
                                             key={card.title}
                                             className=""
                                             onClick={() => handleMBTIClick(card.link, card.title)}
                                        >
                                             <Card
                                                  className="h-[80px] flex flex-row card-style"
                                                  style={{ width: '150px' }}
                                             >
                                                  <div
                    ...
                    <div>
                         <Link to={selectedMBTI ? selectedMBTI.link : "/mbti"}>
