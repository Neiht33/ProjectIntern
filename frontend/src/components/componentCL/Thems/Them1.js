...
function Them1({getData, data, setImgData, urlIMG, setUrlIMG}) {
  ...
  return (
    <div id="App1" onClick={() => {document.querySelector('.block-popup').style.display = 'none'}}>
            ...
            <div className="cvo-page">
              <div className="cvo-subpage">
                <div id="cvo-body">
                  <div id="cvo-main">
                    <div id="col-left">
                      <div id="group-top-left" cvo-block-group="true">
                        <div
                          id="cvo-profile"
                          className="cvo-block"
                          cvo-form-block="true"
                        ...
                        >
                          <div id="profile-title-wrapper">
                            <div id="cvo-profile-avatar-wraper">
                              <img id="cvo-profile-avatar" src={`${urlIMG}`}
                                alt="avatar"
                          ...
                          <div id="profile-contact-wraper">
                            ...
                            <div id="cvo-profile-email-wraper" style={{display: 'flex'}}>
                            ...
                            <div id="cvo-profile-address-wraper" style={{display: 'flex'}}>
          ...
          <div className="editor-col-right">
            ...
            <div className="imageEditorControls">
              ...
              <div className="edit-image-btns" style={{ display: "block" }}>
                <button type="button" className="btn-remove-image" style={{width: '160px'}} onClick={() => {
                  setUpdateUrlIMG('http://localhost:8080/images/c3a1f6a82426f23d9d2954da86b11cca')
                  setImgData('')
                }}>
                  Xóa ảnh
                </button>
